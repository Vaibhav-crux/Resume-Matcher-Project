...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/job_posting.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
SECRET_KEY = 'django-insecure-(6p2os-^m1sc8n9@t1g&xhslrte81@ero&p-_sjtfx!$&5$6&6'
DEBUG = True
ALLOWED_HOSTS = []
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'resume_analyzer.common.errors.custom_exception_handler',
}